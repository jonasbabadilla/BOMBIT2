...
func LevelSix(renderer *sdl.Renderer) (levelData []Object, LevelBG Object, pStart StartData, err error) {

	Surf, _ := sdl.LoadBMP("LEVELS/LevelSixSprites/levelLayout.bmp")
	...
	Surf, _ = sdl.LoadBMP("LEVELS/LevelSixSprites/BG.bmp")
